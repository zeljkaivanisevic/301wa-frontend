            ...
            <nav class="navbar navbar-expand-lg navbar-light mb-2">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="form-inline my-2 my-lg-0 mr-auto ml-5">
                  <input v-model="searchTerm" class="form-control mr-sm-2" type="search" placeholder="Trazi naslov" aria-label="Search" />
                </form>
                <form class="form-inline my-2 my-lg-0 mr-auto ml-5">
                  <input v-model="searchTerm1" class="form-control mr-sm-2" type="search" placeholder="Trazi autora" aria-label="Search" />
                </form>
